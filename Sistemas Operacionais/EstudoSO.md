...
Estados: Novo, Pronto, Em execução, Bloqueado, Finalizado.  
Mudança entre eles depende de eventos como: interrupções, chamadas de sistema, término de execução ou espera por E/S.
